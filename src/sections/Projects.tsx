    ...
    <section id="projects" className="relative bg-background py-24 sm:py-32 px-4 sm:px-6 md:px-12 overflow-hidden border-t border-text/5">
      ...
      <div className="max-w-6xl mx-auto space-y-16 relative z-10">
        ...
        <motion.div
          ...
          className="relative group p-[1px] rounded-3xl bg-gradient-to-r from-accent/20 via-indigo-500/10 to-purple-500/20 hover:from-accent/40 hover:via-indigo-500/30 hover:to-purple-500/40 transition-all duration-500 shadow-2xl mb-16 overflow-hidden"
        ...
        >
          ...
          <div className="relative rounded-[23px] bg-[#0b1329]/90 backdrop-blur-2xl p-8 sm:p-10 flex flex-col lg:flex-row gap-10 lg:gap-14 text-left z-20">
            {/* Left side: Flagship details, Problem/Solution, Actions */}
            <div className="flex-1 space-y-6 flex flex-col justify-between">
              <div className="space-y-4">
                {/* Badges */}
                <div className="flex items-center gap-3">
                  <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-accent/10 border border-accent/20 text-[10px] font-black tracking-widest text-accent uppercase">
                    <Award className="w-3.5 h-3.5" />
                    <span>FLAGSHIP PROJECT</span>
                  </span>
                  <span className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full bg-surface border border-text/10 text-[10px] font-bold text-muted uppercase font-mono">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-muted text-sm sm:text-base font-semibold leading-relaxed">
                ...
                <div className="space-y-4 pt-4 border-t border-text/5">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-muted text-sm leading-relaxed pl-5">
                      As AI-generated code becomes increasingly common, educators, recruiters, and organizations struggle to determine how much of a codebase was written by humans versus generated by AI tools. There is a growing need for transparency and trust in software development.
                    </p>
                  </div>
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-text text-sm leading-relaxed pl-5">
                      Built Sentinel AI, an intelligent code analysis platform that evaluates source code and estimates the likelihood of AI-generated content using machine learning techniques and code pattern analysis.
                    </p>
                  </div>
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-text/90 text-sm leading-relaxed font-semibold pl-5">
                      Helps educators, recruiters, and organizations better understand code authenticity and promotes transparency in software development.
                    </p>
                  </div>
                </div>
              </div>
